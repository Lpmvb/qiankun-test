...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        whitList: {
          ...
          article: [],
          aside: [],
          audio: ['autoplay', 'controls', 'loop', 'preload', 'src', 'class', 'style','controlsList'],
          source:['src'],
          b: ['class', 'style'],
          bdi: ['dir'],
          bdo: ['dir'],
          ...
          hr: [],
          i: ['class', 'style'],
          img: ['src', 'alt', 'title', 'width', 'height', 'id', '_src', '_url', '_poster', 'loadingclass', 'class', 'data-latex', 'style'],
          ins: ['datetime'],
          li: ['class', 'style'],
          mark: [],
          nav: [],
          ...
          u: [],
          ul: ['class', 'style'],
          video: ['autoplay', 'controls', 'loop', 'preload', 'src', 'height', 'poster', 'width', 'class', 'style', 'webkit-playsinline', 'playsinline','poster','_poster']
        }
    };
